...
class SettingRepositoryTest extends PHPUnit\Framework\TestCase
{
  ...
  value TEXT
    ...
    public function testAddSetting()
    {
        ...
        $returnedSetting = \model\SettingRepository::fetchSetting($this->pdo, "OrganizationName");
        $this->assertEquals("Rosenthal Library at Queens College", $returnedSetting->getValue());
    }
    ...
    public function testUpdateSetting()
    {
        ...
        $setting = \model\Setting::create()->setName($settingName)->setValue($settingValue);
        \model\SettingRepository::addSetting($this->pdo, $setting);
        $setting->setValue("Hunter College");
        \model\SettingRepository::updateSetting($this->pdo, $setting);
        $returnedSetting = \model\SettingRepository::fetchSetting($this->pdo, "OrganizationName");
        $this->assertEquals("Hunter College", $returnedSetting->getValue());
    }
}
