...
$tableName = 'duck';
$password = \model\User::hashPassword('hunter2');
...
$populateTableDuck = "INSERT INTO {$tableName} (username, password, email, is_active) VALUES ('admin', {$password}, 'kushaldeveloper@gmail.com', TRUE)";
